...
├── claude_summarize.py   # Claude API 요약/분류/관련도 점수
...
결과를 자동 커밋/푸시한다. 저장소 Settings → Secrets에 `ANTHROPIC_API_KEY`를 등록해야 한다.
...
- [ ] `ANTHROPIC_API_KEY`를 저장소 Secrets에 등록 후 워크플로 첫 실행 확인
